...
export const personajes: Personaje[] = [
  {
    ...
    nombre: 'Limón',
    arquetipo: 'bufón',
    descripcionFisica: 'verde brillante con su boina negra de medio lado',
    voz: {
    ...
    bio: {
      ...
      personalidad: 'Tiene complejo de payaso y usa sus bromas como mecanismo de defensa porque en el fondo sufre mucho.',
      conflictoInterno: 'Sigue triste por la muerte de Naranja y no ha logrado superarla.',
      conflictoExterno: 'Debe ayudar a derrotar a la dictadura de Sal y Azúcar.',
      temor: 'Perder otra vez a sus amigos.',
      quiere: 'Superar a Naranja y volver a enamorarse.',
      haraParaObtenerlo: 'Cuidará a sus amigos y los hará reír el mayor tiempo posible.',
    },
    premium: false,
  },
  {
    ...
    nombre: 'Cebolla',
    arquetipo: 'sabia',
    descripcionFisica: 'morada con tallos verdes y lentes que la hacen ver mayor',
    voz: {
    ...
    bio: {
      ...
      personalidad: 'Sabia, distante, prefiere la soledad pero odia las injusticias.',
      conflictoInterno: 'No acepta que su naturaleza picante sea parte de su valor.',
      conflictoExterno: 'La dictadura persigue y censura el conocimiento, la convierte en objetivo.',
      temor: 'Que sus capas se rompan y termine haciendo llorar a su única familia.',
      quiere: 'Derrocar la dictadura para que el conocimiento florezca.',
      haraParaObtenerlo: 'Usar sus conocimientos de cocina para crear trampas y guiar a Olea.',
    },
    premium: false,
  },
  {
    ...
    bio: {
      ...
      personalidad: 'Dulce, paciente, dedicada al sacrificio. A veces demasiado.',
      conflictoInterno: 'Duda de si su suavidad es suficiente frente a la violencia.',
      conflictoExterno: 'La dictadura ve la ternura como debilidad.',
      temor: 'Desaparecer sin haber cambiado nada.',
      quiere: 'Una alacena libre donde todos los sabores convivan sin jerarquías.',
  ...
  },
  {
    ...
    voz: {
      intro: 'revisaba decretos en su estante alto, asegurándose de que todo siguiera en orden',
    ...
    bio: {
      ...
      personalidad: 'Cree firmemente en las clases sociales. Evita conflictos directos.',
      conflictoInterno: 'Pánico ante la idea de no ser especial si todos son iguales.',
      ...
      haraParaObtenerlo: 'Contratar al Bicarbonato para que haga el trabajo duro por ella.',
    },
    premium: false,
  },
  {
    ...
    nombre: 'Vinagre',
    arquetipo: 'rebelde',
    descripcionFisica: 'botella de cristal con corcho bonito y un aire atemporal',
    voz: {
    ...
    bio: {
      ...
      personalidad: 'Honesto hasta la incomodidad. Rebelde por naturaleza, amargo por defuera, noble por dentro.',
      conflictoInterno: 'Quiere ser villano pero su naturaleza lo limpia y sazona todo.',
      ...
      haraParaObtenerlo: 'Idear planes para combatir al gobierno de la alacena.',
    },
    premium: true,
  },
  {
    ...
    nombre: 'Olea',
    arquetipo: 'mago',
    descripcionFisica: 'botella verde con detalles dorados, la más bonita de la alacena',
    voz: {
      intro: 'tejía alianzas estratégicas con una sonrisa de las que abren puertas',
    ...
    bio: {
      ...
      conflictoInterno: 'No quiere traicionar a su familia noble pero quiere el cambio.',
      ...
      haraParaObtenerlo: 'Ayudará al Vinagre y se asegurará de que todo salga bien.',
    },
    premium: true,
  },
  {
    ...
    bio: {
      ...
      haraParaObtenerlo: 'Manipular a los frascos pequeños y propagar propaganda.',
    },
    premium: true,
  },
  {
    ...
    descripcionFisica: 'señor de traje blanco y corbatín negro, de cara muy cuadrada',
    voz: {
    ...
    bio: {
      ...
      personalidad: 'Obsesivo con el orden. Dominante. Astuto pero no más que Olea.',
      conflictoInterno: 'Está enamorado de Olea y cree que el Vinagre la corrompió.',
